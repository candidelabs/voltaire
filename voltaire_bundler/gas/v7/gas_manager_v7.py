...
class GasManagerV7(GasManager):
    ...
    async def verify_gas_fees_and_get_price(
        self, user_operation: UserOperationV7, enforce_gas_price_tolerance: int
    ) -> str:
    ...
    async def get_preverification_gas(
        ...
        base_preverification_gas = GasManagerV7.calc_base_preverification_gas(
            user_operation
        )
        l1_gas = 0
    ...
    @staticmethod
    def calc_base_preverification_gas(user_operation: UserOperationV7) -> int:
