 ...
 ** This is a modified version of the entrypoint to override the 
 ** entrypoint code during gas estimation using eth_call
 **/
...
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/interfaces/IAccount.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/interfaces/IPaymaster.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/interfaces/IEntryPoint.sol";

import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/utils/Exec.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/core/StakeManager.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/core/SenderCreator.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/core/Helpers.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/v0.6.0/contracts/core/NonceManager.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/security/ReentrancyGuard.sol";

contract EntryPointSimulationsV6WithBinarySearch is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard {

    using UserOperationLib for UserOperation;
    
    // Use the SenderCreator deployed by the real EntryPoint v0.6.
    // This MUST be `constant`, not `immutable`: this bytecode is injected via
    // eth_call state overrides and never runs a constructor, so an immutable
    // would stay as the zero placeholder left in `deployedBytecode` and every
    // op with initCode would call createSender on address(0) and revert with
    // empty data.
    SenderCreator private constant senderCreator = SenderCreator(0x7fc98430eAEdbb6070B35B39D798725049088348);
    ...
    //based on https://github.com/alchemyplatform/rundler/blob/main/crates/types/contracts/src/CallGasEstimationProxy.sol
    ...
    function simulateHandleOpMod(UserOperation calldata op, EstimateCallGasArgs calldata args) external {
