...
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/interfaces/IAccount.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/interfaces/IPaymaster.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/interfaces/IEntryPoint.sol";

import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/utils/Exec.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/core/StakeManager.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/core/SenderCreator.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.6/contracts/core/Helpers.sol";
...
contract EntryPointModV6Arb is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard {
    ...
    error ValidationResultMod(ReturnInfo returnInfo,
        StakeInfo senderInfo, StakeInfo factoryInfo, StakeInfo paymasterInfo,
        uint256 currentBlockNumber, uint256 currentBlockTimeStamp, bytes32 currentBlockHash
    );
    /**
     ...
     */
    function simulateValidationMod(UserOperation calldata userOp, uint256 minBlock) external {
        ArbSys arbSys = ArbSys(0x0000000000000000000000000000000000000064);
        uint256 arbBlockNumber = arbSys.arbBlockNumber();
        require(minBlock == 0 || arbBlockNumber >= minBlock, "current block number is not higher than minBlock");
        ...
        revert ValidationResultMod(
            returnInfo, senderInfo, factoryInfo, paymasterInfo,
