...
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/interfaces/IAccount.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/interfaces/IAccountExecute.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/interfaces/IEntryPoint.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/interfaces/IPaymaster.sol";

import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/UserOperationLib.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/StakeManager.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/NonceManager.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/Helpers.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/SenderCreator.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/core/Eip7702Support.sol";
import "https://github.com/eth-infinitism/account-abstraction/blob/releases/v0.9/contracts/utils/Exec.sol";
...
contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ERC165, EIP712 {
    ...
    SenderCreator private immutable _senderCreator = SenderCreator(0x0A630a99Df908A81115A3022927Be82f9299987e);
