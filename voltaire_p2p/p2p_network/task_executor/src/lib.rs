...
/// Provides a reason when Voltaire is shut down.
...
impl HandleProvider {
    ...
    /// means Voltaire is shutting down).
...
impl TaskExecutor {
    ...
    /// instance of `Self` via a `environment::RuntimeContext` (see the `voltaire/environment`
    /// crate).
    ...
    /// use of this outside of testing should be very deeply considered as Voltaire has been
