//! The discovery sub-behaviour of Voltaire.
//!
...
impl Discovery {
    ...
    // TODO: Group these functions here once the ENR is shared across discv5 and voltaire and
    // Voltaire can modify the ENR directly.
    ...
    // https://github.com/sigp/voltaire/issues/4706
                ...
                while let Poll::Ready(Some(event)) = stream.poll_recv(cx) {
                    match event {
                        ...
                        Discv5Event::Discovered(enr) => {
                            ...
                            trace!(self.log, "Peer found in process of query"; "peer_id" => format!("{}", enr.peer_id()));
                        }
