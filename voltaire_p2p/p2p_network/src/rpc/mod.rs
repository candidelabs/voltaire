...
impl<Id: ReqId> RPC<Id> {
    ...
    /// Voltaire wishes to disconnect from this peer by sending a Goodbye message. This
            ...
            Ok(received) => match received {
                ...
                RPCReceived::EndOfStream(_, end) => (
                    ...
                    match end {
                        ...
                        ResponseTermination::PooledUserOpsByHashV07V08V09 => Protocol::PooledUserOpsByHashV07V08V09,
